...
MODEL_PATH = PROJECT_ROOT / "car_model.pth"
UPLOAD_DIR = FRONTEND_DIR / "static" / "uploads"
ALLOWED_EXTENSIONS = {"png", "jpg", "jpeg", "webp"}
IMG_SIZE = 300
DEFAULT_CURRENCY = "DT"
SCRAPED_DATA_PATH = Path(os.getenv("SCRAPED_DATA_PATH", str(PROJECT_ROOT / "cars_data.json")))
            ...
            try:
                ...
                if price_warning:
                    ...
                    if json_price_map or json_ordered_prices:
                        ...
                        price_warning = "Google Sheets failed, using JSON fallback. " + price_warning
                    elif json_warning:
